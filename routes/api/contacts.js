...
sgMail.setApiKey('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');
...
router.post('/add', async (req, res) => {
   try {
      ...
      sendMail('Contact Form Submission', contact.email, contact.message, contact.fullName.firstName, contact.fullName.lastName, contact.phone)
